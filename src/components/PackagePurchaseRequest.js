...
const PackagePurchaseRequest = () => {
  ...
  const getAllRequest = async () => {
    const response = await fetch(`${url}/api/admin/all-package-request`);
  ...
  const headerPending = (
    <div className="py-2">
      <div className="row">
        <div className="col-lg-6 d-flex">
          <h4 className="m-0">Pending Package Purchase Request</h4>
        </div>
        <div className="col-lg-6">
          <IconField iconPosition="left">
            <InputIcon className="pi pi-search" />
  ...
  const headerAll = (
    <div className="py-2">
      <div className="row">
        <div className="col-lg-6 d-flex">
          <h4 className="m-0">All Package Purchase Request</h4>
        </div>
        <div className="col-lg-6">
          <IconField iconPosition="left">
            <InputIcon className="pi pi-search" />
  ...
  const SaveData = async () => {
    const response = await fetch(`${url}/api/admin/accept-package-request`, {
      method: "post",
      body: JSON.stringify({
        id: selectedData._id,
        ...
        packageName: selectedData.packageName,
      }),
      headers: {
        "Content-Type": "application/json",
      },
        ...
        <nav>
          <div className="nav nav-tabs mb-3 p-3" id="nav-tab" role="tablist">
            ...
            <button
              ...
              aria-selected="false"
            >
              Pending Package Purchase Request
            </button>
            <button
              className="nav-link px-3 py-2"
              id="nav-contact-tab"
              ...
              aria-selected="false"
            >
              Complete Package Purchase Request
            </button>
          </div>
        </nav>
          ...
          >
            ...
            >
              ...
              <Column
                ...
                sortable
              ></Column>
              <Column field="packageId" header="Pkg Id" sortable></Column>
              <Column field="packageName" header="Pkg Name" sortable></Column>
...
export default PackagePurchaseRequest;
